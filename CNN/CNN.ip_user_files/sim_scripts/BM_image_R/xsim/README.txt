...
#
# Generated by export_simulation on Tue Jun 05 02:21:29 +0300 2018
#
################################################################################
...
'-reset_run' switch to the './BM_image_R.sh' script.

./BM_image_R.sh -reset_run
...
./BM_image_R.sh -noclean_files

For more information on the script, please type './BM_image_R.sh -help'.
